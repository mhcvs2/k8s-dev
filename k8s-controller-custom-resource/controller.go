...
import (
	...
	mhcv1 "k8s-dev/k8s-controller-custom-resource/pkg/apis/mhc/v1"
	clientset "k8s-dev/k8s-controller-custom-resource/pkg/client/clientset/versioned"
	networkscheme "k8s-dev/k8s-controller-custom-resource/pkg/client/clientset/versioned/scheme"
	informers "k8s-dev/k8s-controller-custom-resource/pkg/client/informers/externalversions/mhc/v1"
	listers "k8s-dev/k8s-controller-custom-resource/pkg/client/listers/mhc/v1"
)
