...
import (
	...
	versioned "k8s-dev/k8s-controller-custom-resource/pkg/client/clientset/versioned"
	internalinterfaces "k8s-dev/k8s-controller-custom-resource/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-dev/k8s-controller-custom-resource/pkg/client/listers/mhc/v1"
	time "time"
